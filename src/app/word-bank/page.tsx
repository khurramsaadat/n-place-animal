              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2">
                  {searchFilter(words).sort().map((word, index) => (
                    <span
                      key={`${word}-${index}`}
                      className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-purple-50 text-purple-700 hover:bg-purple-100 transition-colors duration-200"
                    >
                      {word}
                    </span>
                  ))}
