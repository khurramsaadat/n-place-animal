      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 text-center">
          <div className="mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Coming Soon!</h2>
          ...
          <div className="space-y-4">
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-4">
              <h3 className="font-semibold text-purple-600 dark:text-purple-400 mb-2">🏆 Global Rankings</h3>
              <p className="text-gray-600 dark:text-gray-300">Compete with players from around the world</p>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-4">
              <h3 className="font-semibold text-purple-600 dark:text-purple-400 mb-2">📊 Daily & Weekly Challenges</h3>
              <p className="text-gray-600 dark:text-gray-300">New competitions every day and week</p>
            </div>
            <div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-4">
              <h3 className="font-semibold text-purple-600 dark:text-purple-400 mb-2">🌟 Achievement System</h3>
              <p className="text-gray-600 dark:text-gray-300">Earn badges and unlock special rewards</p>
            </div>
          </div>
